		...
		},
		{
			...
			Handle: func(s core.Sender) interface{} {
				...
				for i := range crons {
					...
					if strings.Contains(crons[i].Command, "jd_redEnvelope.js") || strings.Contains(crons[i].Command, "1111") || strings.Contains(strings.ToLower(crons[i].Command), "jd_red.js") || strings.Contains(strings.ToLower(crons[i].Command), "jd_hongbao.js") {
